...
class pantilt_object_tracker_action(object):
  ...
  def pt_status_callback(self,PanTiltStatus):
    ...
    PanTiltStatus.reverse_pitch_control = PanTiltStatus.reverse_pitch_control == False
    PanTiltStatus.reverse_yaw_control = PanTiltStatus.reverse_yaw_control == False
