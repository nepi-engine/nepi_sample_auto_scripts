...
class Sealite_Node(object):
  ...
  def __init__(self,port_str,buad_int,addr_str):
    ...
    DEVICE_NAME = "sealite_" + self.dev_addr_str
    NEPI_LSX_BASENAME = rospy.get_namespace() + DEVICE_NAME  + "/lsx/"
    NEPI_LSX_CAPABILITY_REPORT_SERVICE = NEPI_LSX_BASENAME + DEVICE_NAME + "capabilities_query"
